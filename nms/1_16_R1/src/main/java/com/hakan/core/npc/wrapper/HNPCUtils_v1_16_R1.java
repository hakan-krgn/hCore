 ...
 */
public final class HNPCUtils_v1_16_R1 {
    ...
    public void walk(@Nonnull HNPC npc, @Nonnull Location to, double speed, @Nonnull Runnable callback) {
        ...
        EntityVillager villager = new EntityVillager(EntityTypes.VILLAGER, world);
        ...
        AttributeModifiable villagerAttribute = villager.getAttributeInstance(GenericAttributes.MOVEMENT_SPEED);
        if (villagerAttribute != null)
            villagerAttribute.setValue(speed);

        AttributeModifiable zombieAttribute = zombie.getAttributeInstance(GenericAttributes.MOVEMENT_SPEED);
