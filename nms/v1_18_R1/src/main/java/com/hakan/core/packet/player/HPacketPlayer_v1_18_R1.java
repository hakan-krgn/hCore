 ...
 * {@inheritDoc}
 */
public final class HPacketPlayer_v1_18_R1 extends HPacketPlayer {
     ...
     * {@inheritDoc}
     */
    public HPacketPlayer_v1_18_R1(@Nonnull Player player) {
        super(player);
    ...
    public void register() {
        try {
            this.pipeline = this.connection.a.k.pipeline().addBefore("packet_handler", CHANNEL + super.player.getUniqueId(), new ChannelDuplexHandler() {
                @Override
