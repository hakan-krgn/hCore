 ...
 * {@inheritDoc}
 */
public final class HNpcEntity_v1_18_R1 implements HNpcEntity {
     ...
     * {@inheritDoc}
     */
    public HNpcEntity_v1_18_R1(@Nonnull HNPC hnpc) {
    ...
    public void walk(double speed, @Nonnull Location to, @Nonnull Runnable runnable) {
        PathfinderEntity_v1_18_R1.create(this.hnpc.getLocation(), to, speed,
