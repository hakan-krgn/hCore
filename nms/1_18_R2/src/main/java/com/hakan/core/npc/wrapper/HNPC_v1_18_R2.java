...
import com.hakan.core.npc.listeners.HNpcClickListener_v1_18_R2;
 ...
 * {@inheritDoc}
 */
public final class HNPC_v1_18_R2 extends HNPC {

    private final HNPCUtils_v1_18_R2 utils;
    private final HNpcClickListener_v1_18_R2 listener;
     ...
     * {@inheritDoc}
     */
    public HNPC_v1_18_R2(@Nonnull String id,
                         @Nonnull String skin,
        ...
        this.utils = new HNPCUtils_v1_18_R2();
        this.listener = new HNpcClickListener_v1_18_R2(this);
    ...
    public HNPC show(@Nonnull List<Player> players) {
        ...
        HCore.syncScheduler().after(6)
                .run(() -> HCore.sendPacket(players, new PacketPlayOutEntityMetadata(this.npc.ae(), this.utils.createDataWatcher(), true)));
        HCore.syncScheduler().after(6)
