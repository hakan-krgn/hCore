 ...
 * {@inheritDoc}
 */
public class HPacketPlayer_v1_18_R2 extends HPacketPlayer {
     ...
     * {@inheritDoc}
     */
    public HPacketPlayer_v1_18_R2(Player player) {
        super(player);
        this.connection = ((CraftPlayer) this.player).getHandle().b;
    }
