 ...
 * {@inheritDoc}
 */
public final class BossBar_v1_9_R1 implements BossBar {
     ...
     * {@inheritDoc}
     */
    public BossBar_v1_9_R1(@Nonnull String title, @Nonnull BarColor color, @Nonnull BarStyle style, @Nonnull BarFlag... flags) {
