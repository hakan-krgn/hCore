 ...
 * {@inheritDoc}
 */
public final class AnvilWrapper_v1_15_R1 extends AnvilWrapper {
     ...
     * {@inheritDoc}
     */
    private AnvilWrapper_v1_15_R1(@Nonnull AnvilGui anvilGui) {
        super(anvilGui);
    ...
    public void open() {
        ...
        HCore.sendPacket(this.player, new PacketPlayOutOpenWindow(this.nextContainerId, Containers.ANVIL, new ChatMessage(super.anvilGui.getTitle())));
    ...
    private final class AnvilContainer extends ContainerAnvil {
        ...
        public AnvilContainer(@Nonnull EntityHuman entityHuman) {
            ...
            super.setTitle(new ChatMessage(anvilGui.getTitle()));
        }
