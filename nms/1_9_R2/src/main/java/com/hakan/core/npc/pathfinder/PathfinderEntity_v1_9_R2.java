 ...
 * custom entity class.
 */
public final class PathfinderEntity_v1_9_R2 extends EntityPig {
     ...
     * @return PathfinderEntity_v1_9_R2 instance.
     */
    public static PathfinderEntity_v1_9_R2 create(@Nonnull Location start,
                                                  @Nonnull Location end,
                                                  double speed,
                                                  @Nonnull Consumer<PathfinderEntity_v1_9_R2> walkRunnable,
                                                  @Nonnull Consumer<PathfinderEntity_v1_9_R2> endRunnable) {
        ...
        return new PathfinderEntity_v1_9_R2(world, start, end, speed, walkRunnable, endRunnable);
    }
     ...
     * @param endRunnable  Runnable to run when entity is ended.
     */
    private PathfinderEntity_v1_9_R2(@Nonnull World world,
        ...
        super.goalSelector.a(2, new PathfinderGoal_v1_9_R2(this, end, speed,
