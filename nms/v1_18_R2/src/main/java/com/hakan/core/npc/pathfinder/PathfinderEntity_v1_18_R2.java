...
public final class PathfinderEntity_v1_18_R2 {
     ...
     * @return PathfinderEntity_v1_18_R2 instance.
     */
    public static PathfinderEntity_v1_18_R2 create(@Nonnull Location start,
        ...
        return new PathfinderEntity_v1_18_R2(world, start, end, speed, walkRunnable, endRunnable);
    }
     ...
     * @param endRunnable  Runnable to run when entity is ended.
     */
    private PathfinderEntity_v1_18_R2(@Nonnull World world,
        ...
        this.pig.bR.a(2, new PathfinderGoal_v1_18_R2(this.pig, end, speed,
