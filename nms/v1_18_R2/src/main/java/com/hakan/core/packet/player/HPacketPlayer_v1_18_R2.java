 ...
 * {@inheritDoc}
 */
public final class HPacketPlayer_v1_18_R2 extends HPacketPlayer {
     ...
     * {@inheritDoc}
     */
    public HPacketPlayer_v1_18_R2(@Nonnull Player player) {
        super(player);
    ...
    public void register() {
        try {
            this.pipeline = this.connection.a.m.pipeline().addBefore("packet_handler", CHANNEL + super.player.getUniqueId(), new ChannelDuplexHandler() {
                @Override
