 ...
 * {@inheritDoc}
 */
public final class BossBar_v1_18_R2 implements BossBar {
     ...
     * {@inheritDoc}
     */
    public BossBar_v1_18_R2(@Nonnull String title, @Nonnull BarColor color, @Nonnull BarStyle style, @Nonnull BarFlag... flags) {
