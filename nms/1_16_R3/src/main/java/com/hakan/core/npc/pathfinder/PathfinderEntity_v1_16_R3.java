 ...
 * custom entity class.
 */
public final class PathfinderEntity_v1_16_R3 extends EntityPig {
    ...
    public static PathfinderEntity_v1_16_R3 create(@Nonnull Location start,
                                                   ...
                                                   double speed,
                                                   @Nonnull Consumer<PathfinderEntity_v1_16_R3> walkRunnable,
                                                   @Nonnull Consumer<PathfinderEntity_v1_16_R3> endRunnable) {
    ...
    private PathfinderEntity_v1_16_R3(@Nonnull World world,
        ...
        super.goalSelector.a(2, new PathfinderGoal_v1_16_R3(this, end, speed,
