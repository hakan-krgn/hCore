...
import com.hakan.core.npc.pathfinder.PathfinderEntity_v1_16_R2;
 ...
 * {@inheritDoc}
 */
public final class HNpcEntity_v1_16_R2 implements HNpcEntity {
     ...
     * {@inheritDoc}
     */
    public HNpcEntity_v1_16_R2(@Nonnull HNPC hnpc) {
    ...
    public void walk(double speed, @Nonnull Location to, @Nonnull Runnable runnable) {
        PathfinderEntity_v1_16_R2.create(this.hnpc.getLocation(), to, speed,
