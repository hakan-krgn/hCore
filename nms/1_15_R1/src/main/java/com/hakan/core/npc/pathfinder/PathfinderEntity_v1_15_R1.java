 ...
 * custom entity class.
 */
public final class PathfinderEntity_v1_15_R1 extends EntityPig {
     ...
     * @return PathfinderEntity_v1_15_R1 instance.
     */
    public static PathfinderEntity_v1_15_R1 create(@Nonnull Location start,
                                                   @Nonnull Location end,
                                                   double speed,
                                                   @Nonnull Consumer<PathfinderEntity_v1_15_R1> walkRunnable,
                                                   @Nonnull Consumer<PathfinderEntity_v1_15_R1> endRunnable) {
        ...
        return new PathfinderEntity_v1_15_R1(world, start, end, speed, walkRunnable, endRunnable);
    }
     ...
     * @param endRunnable  Runnable to run when entity is ended.
     */
    private PathfinderEntity_v1_15_R1(@Nonnull World world,
        ...
        super.goalSelector.a(2, new PathfinderGoal_v1_15_R1(this, end, speed,
