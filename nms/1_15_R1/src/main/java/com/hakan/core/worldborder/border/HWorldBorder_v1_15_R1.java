...
public final class HWorldBorder_v1_15_R1 extends WorldBorder implements HWorldBorder {
     ...
     * {@inheritDoc}
     */
    public HWorldBorder_v1_15_R1(Location location, double size, double damageAmount, double damageBuffer, int warningDistance, int warningTime, HBorderColor color) {
        this.color = color;
