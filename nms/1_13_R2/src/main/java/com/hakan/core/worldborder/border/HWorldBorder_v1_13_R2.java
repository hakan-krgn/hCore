 ...
 * {@inheritDoc}
 */
public final class HWorldBorder_v1_13_R2 extends WorldBorder implements HWorldBorder {
     ...
     * {@inheritDoc}
     */
    public HWorldBorder_v1_13_R2(@Nonnull Location location, double size, double damageAmount, double damageBuffer, int warningDistance, int warningTime, @Nonnull HBorderColor color) {
