...
public final class HWorldBorder_v1_13_R2 extends WorldBorder implements HWorldBorder {
     ...
     * {@inheritDoc}
     */
    public HWorldBorder_v1_13_R2(Location location, double size, double damageAmount, double damageBuffer, int warningDistance, int warningTime, HBorderColor color) {
        this.color = color;
