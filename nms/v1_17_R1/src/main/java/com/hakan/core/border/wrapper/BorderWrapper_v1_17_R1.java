 ...
 * {@inheritDoc}
 */
public final class BorderWrapper_v1_17_R1 extends WorldBorder implements Border {
     ...
     * {@inheritDoc}
     */
    public BorderWrapper_v1_17_R1(@Nonnull Location location, double size, double damageAmount, double damageBuffer, int warningDistance, int warningTime, @Nonnull BorderColor color) {
