 ...
 * {@inheritDoc}
 */
public final class Border_v1_16_R2 extends net.minecraft.server.v1_16_R2.WorldBorder implements Border {
     ...
     * {@inheritDoc}
     */
    public Border_v1_16_R2(@Nonnull Location location, double size, double damageAmount, double damageBuffer, int warningDistance, int warningTime, @Nonnull BorderColor color) {
