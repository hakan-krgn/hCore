 ...
 * {@inheritDoc}
 */
public final class HBossBar_v1_16_R2 implements HBossBar {
     ...
     * {@inheritDoc}
     */
    public HBossBar_v1_16_R2(@Nonnull String title, @Nonnull HBarColor color, @Nonnull HBarStyle style, @Nonnull HBarFlag... flags) {
