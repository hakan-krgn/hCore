 ...
 * {@inheritDoc}
 */
public final class Border_v1_14_R1 extends net.minecraft.server.v1_14_R1.WorldBorder implements Border {
     ...
     * {@inheritDoc}
     */
    public Border_v1_14_R1(@Nonnull Location location, double size, double damageAmount, double damageBuffer, int warningDistance, int warningTime, @Nonnull BorderColor color) {
