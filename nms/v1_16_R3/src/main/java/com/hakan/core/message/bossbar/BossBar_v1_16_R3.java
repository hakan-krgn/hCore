 ...
 * {@inheritDoc}
 */
public final class BossBar_v1_16_R3 implements BossBar {
     ...
     * {@inheritDoc}
     */
    public BossBar_v1_16_R3(@Nonnull String title, @Nonnull BarColor color, @Nonnull BarStyle style, @Nonnull BarFlag... flags) {
