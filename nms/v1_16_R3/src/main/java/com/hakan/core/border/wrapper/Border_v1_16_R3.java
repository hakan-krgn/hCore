 ...
 * {@inheritDoc}
 */
public final class Border_v1_16_R3 extends net.minecraft.server.v1_16_R3.WorldBorder implements Border {
     ...
     * {@inheritDoc}
     */
    public Border_v1_16_R3(@Nonnull Location location, double size, double damageAmount, double damageBuffer, int warningDistance, int warningTime, @Nonnull BorderColor color) {
