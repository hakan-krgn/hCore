...
public final class PathfinderEntity_v1_11_R1 extends EntityPig {
    ...
    public static PathfinderEntity_v1_11_R1 create(@Nonnull Location start,
                                                   ...
                                                   double speed,
                                                   @Nonnull Consumer<PathfinderEntity_v1_11_R1> walkRunnable,
                                                   @Nonnull Consumer<PathfinderEntity_v1_11_R1> endRunnable) {
    ...
    private PathfinderEntity_v1_11_R1(@Nonnull World world,
        ...
        super.goalSelector.a(2, new PathfinderGoal_v1_11_R1(this, end, speed,
