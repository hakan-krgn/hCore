 ...
 * {@inheritDoc}
 */
public final class AnvilWrapper_v1_19_1_R1 extends AnvilGui {
     ...
     * {@inheritDoc}
     */
    public AnvilWrapper_v1_19_1_R1(@Nonnull Player player,
    ...
    public AnvilGui open(boolean runnableActivity) {
        ...
        HCore.sendPacket(super.player, new PacketPlayOutOpenWindow(this.nextContainerId, Containers.h, CraftChatMessage.fromStringOrNull(super.title)));
    ...
    private final class AnvilContainer extends ContainerAnvil {
        ...
        public AnvilContainer(@Nonnull EntityHuman entityhuman) {
            super(nextContainerId, entityhuman.fA(), ContainerAccess.a(entityhuman.s, new BlockPosition(0, 0, 0)));
