 ...
 * custom entity class.
 */
public final class PathfinderEntity_v1_19_R1_2 {
     ...
     * @return PathfinderEntity_v1_19_R1_2 instance.
     */
    public static PathfinderEntity_v1_19_R1_2 create(@Nonnull Location start,
        ...
        return new PathfinderEntity_v1_19_R1_2(world, start, end, speed, walkRunnable, endRunnable);
    }
     ...
     * @param endRunnable  Runnable to run when entity is ended.
     */
    private PathfinderEntity_v1_19_R1_2(@Nonnull World world,
        ...
        this.pig.bS.a(2, new PathfinderGoal_v1_19_R1_2(this.pig, end, speed,
