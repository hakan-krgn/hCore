 ...
 */
public final class PathfinderGoal_v1_18_R1 extends PathfinderGoal {
     ...
     */
    public PathfinderGoal_v1_18_R1(@Nonnull EntityInsentient entity,
    ...
    @Override
    public void c() {
        NavigationAbstract navigation = this.entity.D();
