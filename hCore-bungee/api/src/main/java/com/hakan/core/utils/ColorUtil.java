...
public final class ColorUtil {
    ...
    /**
     * Convert a com.hakan.core.message to a colored com.hakan.core.message.
     *
     * @param message The com.hakan.core.message to convert.
     * @return The colored com.hakan.core.message.
     */
    @Nonnull
