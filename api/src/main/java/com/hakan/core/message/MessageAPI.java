...
import com.hakan.core.message.actionbar.ActionBarHandler;
...
import com.hakan.core.message.title.TitleHandler;
...
public class MessageAPI {
    ...
    public static void initialize() {
        try {
            ...
            MessageAPI.actionBarHandler = (ActionBarHandler) Class.forName("com.hakan.core.message.actionbar.ActionBarHandler_" + version).getConstructor().newInstance();
            MessageAPI.titleHandler = (TitleHandler) Class.forName("com.hakan.core.message.title.TitleHandler_" + version).getConstructor().newInstance();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
