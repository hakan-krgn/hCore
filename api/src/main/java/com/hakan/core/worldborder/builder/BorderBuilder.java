...
public final class BorderBuilder {
    ...
    @Nonnull
    public Border build() {
        Border border = ReflectionUtils.newInstance("com.hakan.core.worldborder.border.Border_%s",
