 ...
 * {@inheritDoc}
 */
public final class AnvilGui_v1_20_R1 extends AnvilGui {
     ...
     * {@inheritDoc}
     */
    private AnvilGui_v1_20_R1(@Nonnull Player player,
    ...
    public AnvilGui open(boolean runnableActivity) {
        this.entityPlayer.bR = this.entityPlayer.bQ;
        ...
        this.entityPlayer.bR = this.container;
    ...
    private final class AnvilContainer extends ContainerAnvil {
        ...
        public AnvilContainer(@Nonnull EntityHuman entityHuman) {
            super(nextContainerId, entityHuman.fN(), ContainerAccess.a(entityHuman.dI(), new BlockPosition(0, 0, 0)));
