 ...
 * {@inheritDoc}
 */
public final class TextLine_v1_20_R1 implements TextLine {
     ...
     * {@inheritDoc}
     */
    private TextLine_v1_20_R1(@Nonnull Hologram hologram, @Nonnull Location location) {
    ...
    public void setLocation(@Nonnull Location location) {
        ...
        World world = ((CraftWorld) Validate.notNull(location.getWorld())).getHandle();
        if (!world.equals(this.click.dI())) ReflectionUtils.setField(this.click, "t", world);
        if (!world.equals(this.armorStand.dI())) ReflectionUtils.setField(this.armorStand, "t", world);
