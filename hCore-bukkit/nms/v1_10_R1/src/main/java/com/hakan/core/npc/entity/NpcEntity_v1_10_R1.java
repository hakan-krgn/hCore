 ...
 * {@inheritDoc}
 */
public final class NpcEntity_v1_10_R1 implements NpcEntity {
     ...
     * {@inheritDoc}
     */
    public NpcEntity_v1_10_R1(@Nonnull Npc npc) {
    ...
    public void walk(double speed, @Nonnull Location to, @Nonnull Runnable runnable) {
        PathfinderEntity_v1_10_R1.create(this.npc.getLocation(), to, speed,
