 ...
 * {@inheritDoc}
 */
public final class PacketPlayer_v1_18_R1 extends PacketPlayer {
     ...
     * {@inheritDoc}
     */
    public PacketPlayer_v1_18_R1(@Nonnull Player player) {
        super(player);
    ...
    public void register() {
        try {
            super.pipeline = this.connection.a.k.pipeline().addBefore("packet_handler", CHANNEL + super.player.getUniqueId(), new ChannelDuplexHandler() {
                @Override
