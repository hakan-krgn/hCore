 ...
 * custom entity class.
 */
public final class PathfinderEntity_v1_17_R1 {
     ...
     * @return PathfinderEntity_v1_17_R1 instance.
     */
    public static PathfinderEntity_v1_17_R1 create(@Nonnull Location start,
        ...
        return new PathfinderEntity_v1_17_R1(world, start, end, speed, walkRunnable, endRunnable);
    }
     ...
     * @param endRunnable  Runnable to run when entity is ended.
     */
    private PathfinderEntity_v1_17_R1(@Nonnull World world,
                                      @Nonnull Location start,
                                      @Nonnull Location end,
                                      double speed,
                                      @Nonnull Consumer<EntityPig> walkRunnable,
                                      @Nonnull Consumer<EntityPig> endRunnable) {
        this.entityPig = new EntityPig(EntityTypes.an, Validate.notNull(world)) {
            @Override
        ...
        this.entityPig.bP.a(2, new PathfinderGoal_v1_17_R1(this.entityPig, end, speed,
