 ...
 * {@inheritDoc}
 */
public final class PacketPlayer_v1_18_R2 extends PacketPlayer {
     ...
     * {@inheritDoc}
     */
    public PacketPlayer_v1_18_R2(@Nonnull Player player) {
        super(player);
    ...
    public void register() {
        try {
            super.pipeline = this.connection.a.m.pipeline().addBefore("packet_handler", CHANNEL + super.player.getUniqueId(), new ChannelDuplexHandler() {
                @Override
