 ...
 * {@inheritDoc}
 */
public final class AnvilGui_v1_20_R3 extends AnvilGui {
     ...
     * {@inheritDoc}
     */
    private AnvilGui_v1_20_R3(@Nonnull Player player,
    ...
    private final class AnvilContainer extends ContainerAnvil {
        ...
        public AnvilContainer(@Nonnull EntityHuman entityHuman) {
            super(nextContainerId, entityHuman.fS(), ContainerAccess.a(entityHuman.dM(), new BlockPosition(0, 0, 0)));
