 ...
 * {@inheritDoc}
 */
public final class AnvilGui_v1_20_R2 extends AnvilGui {
     ...
     * {@inheritDoc}
     */
    private AnvilGui_v1_20_R2(@Nonnull Player player,
    ...
    public AnvilGui open(boolean runnableActivity) {
        this.entityPlayer.bS = this.entityPlayer.bR;
        ...
        this.entityPlayer.bS = this.container;
    ...
    private final class AnvilContainer extends ContainerAnvil {
        ...
        public AnvilContainer(@Nonnull EntityHuman entityHuman) {
            super(nextContainerId, entityHuman.fR(), ContainerAccess.a(entityHuman.dL(), new BlockPosition(0, 0, 0)));
