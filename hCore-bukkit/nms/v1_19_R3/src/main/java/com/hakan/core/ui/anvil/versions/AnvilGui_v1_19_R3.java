 ...
 * {@inheritDoc}
 */
public final class AnvilGui_v1_19_R3 extends AnvilGui {
     ...
     * {@inheritDoc}
     */
    private AnvilGui_v1_19_R3(@Nonnull Player player,
    ...
    public AnvilGui open(boolean runnableActivity) {
        this.entityPlayer.bP = this.entityPlayer.bO;
        ...
        this.entityPlayer.bP = this.container;
    ...
    private final class AnvilContainer extends ContainerAnvil {
        ...
        public AnvilContainer(@Nonnull EntityHuman entityHuman) {
            super(nextContainerId, entityHuman.fJ(), ContainerAccess.a(entityHuman.H, new BlockPosition(0, 0, 0)));
