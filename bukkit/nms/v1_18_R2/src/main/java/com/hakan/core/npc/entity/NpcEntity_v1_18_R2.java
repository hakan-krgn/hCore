 ...
 * {@inheritDoc}
 */
public final class NpcEntity_v1_18_R2 implements NpcEntity {
     ...
     * {@inheritDoc}
     */
    public NpcEntity_v1_18_R2(@Nonnull Npc npc) {
    ...
    public void walk(double speed, @Nonnull Location to, @Nonnull Runnable runnable) {
        PathfinderEntity_v1_18_R2.create(this.npc.getLocation(), to, speed,
