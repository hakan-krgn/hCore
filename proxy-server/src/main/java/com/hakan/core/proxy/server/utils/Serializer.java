package com.hakan.core.proxy.server.utils;
...
public final class Serializer {
     ...
     */
    @Nonnull
    public synchronized static <T extends Serializable> Optional<T> deserializeSafe(@Nonnull String serializedText, @Nonnull Class<T> clazz) {
        try {
     ...
     */
    @Nonnull
    public synchronized static <T extends Serializable> T deserialize(@Nonnull String serializedText, @Nonnull Class<T> clazz) {
